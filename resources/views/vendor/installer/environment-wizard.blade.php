        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="http://www.blog.test" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
                ...
                <div class="block">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group {{ $errors->has('session_driver') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="session_driver" id="session_driver" value="redis" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.session_placeholder') }}" />
                ...
                <div class="block">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group {{ $errors->has('redis_password') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="redis_password" id="redis_password" value="null" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.redis_password') }}" />
