@extends('layouts.app')
@section('title', '编辑管理 - '.sysConfig('SITE_NAME'))
@section('body')
        ...
        <div class="col-9">
          <div class="card">
            <div class="card-header">
              <i class="fa fa-folder-open" aria-hidden="true"></i> 编辑分类
            </div>
            <div class="card-body">
              <!-- start message tips -->
            ...
            <!-- end message tips -->
              ...
              <form action="{{ route('category.update',$category->id) }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="sort" name="sort" value="{{$category->sort}}" required>
                </div>
                <div class="form-group">
                  <label for="description">分类描述</label>
                  <textarea name="description" class="form-control" id="description" rows="4"
                            placeholder="不要超过150字" required>{{$category->description}}</textarea>
                </div>
